...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/29 10:35:58 by pmihangy          #+#    #+#             */
/*   Updated: 2024/05/29 13:00:39 by pmihangy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Check if julia's parameters are number */
int	is_valid(char *s)
{
	int	i;
...
/* Continuation of errors checking */
